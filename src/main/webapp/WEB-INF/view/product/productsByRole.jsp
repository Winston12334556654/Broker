...
<body>
<h1>Products by Premium members.</h1>

<c:set var="roleProducts" value="${roleProducts}" />
<c:if test="${not empty roleProducts}">
    <div class="main-container">
        <c:forEach items="${roleProducts}" var="product">
            ...
            <div class="product-container">
                <div class="product-reaction">
                    <button class="poke-button">Poke</button>
                    <!-- You can replace "Poke" with your desired reaction label or icon -->
                </div>
...
<c:if test="${empty roleProducts}">
    <p>No products found for your role.</p>
</c:if>
